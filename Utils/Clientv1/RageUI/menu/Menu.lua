...
---@return table
---@public
function OnlylifeUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = OnlylifeUI.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = OnlylifeUI.UI.Style[OnlylifeUI.UI.Current].Width
    Menu.Open = false
    Menu.Controls = OnlylifeUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + OnlylifeUI.Settings.Items.Subtitle.Text.X, Menu.Y + OnlylifeUI.Settings.Items.Subtitle.Text.Y, 0, OnlylifeUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, OnlylifeUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, OnlylifeUI.Menus)
end
...
---@return table
---@public
function OnlylifeUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function OnlylifeUI.Menus:SetTitle(Title)
    self.Title = Title
end

function OnlylifeUI.Menus:DisplayInstructionalButton(boolean)
    self.Display.InstructionalButton = boolean;
    return self.Display.InstructionalButton;
end

function OnlylifeUI.Menus:DisplaySubtitle(boolean)
    self.Display.Subtitle = boolean;
    return self.Display.Subtitle;
end

function OnlylifeUI.Menus:DisplayNavigation(boolean)
    self.Display.Navigation = boolean;
    return self.Display.Navigation;
end

function OnlylifeUI.Menus:DisplayPageCounter(boolean)
...
---@return nil
---@public
function OnlylifeUI.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function OnlylifeUI.Menus:GetStyleSize()
...
---@return void
---@public
function OnlylifeUI.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function OnlylifeUI.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function OnlylifeUI.Menus:UpdateCursorStyle()
...
---@return void
---@public
function OnlylifeUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function OnlylifeUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + OnlylifeUI.Settings.Items.Subtitle.Text.X, self.Y + OnlylifeUI.Settings.Items.Subtitle.Text.Y, 0, OnlylifeUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, OnlylifeUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function OnlylifeUI.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function OnlylifeUI.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function OnlylifeUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function OnlylifeUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function OnlylifeUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function OnlylifeUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function OnlylifeUI.Menus:Closable(boolean)
...
function OnlylifeUI.Menus:AddInstructionButton(button)
...
function OnlylifeUI.Menus:RemoveInstructionButton(button)
...
function OnlylifeUI.Menus:UpdateInstructionalButtons(Visible)
