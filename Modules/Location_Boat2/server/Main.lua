...
RegisterNetEvent('Onlylife:Location_Cayo2.spawnBoat', function(vehicle, coords, heading)
...
ESX.RegisterServerCallback('Onlylife:Location_Cayo2.checkMoney', function(source, cb, ToPay)
