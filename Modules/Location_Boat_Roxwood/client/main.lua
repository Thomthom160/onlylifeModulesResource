            ...
            CreateThread(function()
                while OnlyLife.Client.open do
                    ...
                    RageUI.IsVisible(OnlyLife.Client.Location_Boat, function()
                        for k, v in pairs(Location_Boat_Roxwood_cfg.location) do
...
function OnlyLife.Client:SpawnVehicle(car)
    ...
    --    Citizen.Wait(0)
    --end
    for k, v in pairs(Location_Boat_Roxwood_cfg.Spawn) do
...
Citizen.CreateThread(function()
        while true do
            local Waito = false
            for _, info in pairs(Location_Boat_Roxwood_cfg.Position) do
...
Citizen.CreateThread(function()
    ...
    local npc = CreatePed(4, "a_m_y_beach_01", -973.3060, 6542.7842, 0.8877, 355.8991, false, true)
