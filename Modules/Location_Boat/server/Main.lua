...
RegisterNetEvent('Onlylife:Location_Boat.spawnBoat', function(vehicle, coords, heading)
...
ESX.RegisterServerCallback('Onlylife:Location_Boat.checkMoney', function(source, cb, ToPay)
